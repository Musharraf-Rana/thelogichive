...
@section('title')
    <title>Logo Design And Web Design Portfolio | The Logic Hive </title>
@endsection
...
<div class="section-padding portfolio_fold portfolio_page">
    <div class="container">
      ...
      <p class="text-center wow fadeInDown" data-wow-delay="0.4s">Design excellence can’t really be achieved without
        working side <br>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
          ...
          <div id="" class="js-grid-mosaic-flat cbp cbp-l-grid-mosaic-flat consultancy ">
            <div class="cbp-item real-estate-property abstract construction entertainment technology abstract identity">
              <a href="#portfolio01" data-toggle="modal" class="cbp-caption " data-title="Bolt UI<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio64" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-16.gif')}}"> </div>
            ...
            <div class="cbp-caption-defaultWrap"> <img src="https://www.designproficient.com/{{asset('assets/img/portfolio/17.png')}}"> </div>
            ...
            <div
              class="cbp-item travel-hospitality abstract consultancy construction entertainment technology identity">
              <a href="#portfolio17" data-toggle="modal" class="cbp-caption "
            ...
            <div class="cbp-item web-design"> <a href="#portfolio37" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/NK_Beast-Strong-sports-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio56" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-09.gif')}}"> </div>
            ...
            <div class="cbp-item travel-hospitality abstract consultancy medical entertainment technology identity"> <a
                href="#portfolio05" data-toggle="modal" class="cbp-caption " data-title="iDevices<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio59" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-11.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item travel-hospitality"> <a href="#portfolio39" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/NK_Lean-Guitar-Online-education-t.png')}}">
                </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item software-hi-tech accounting fundst medical management justice consultancy identity"> <a
                href="#portfolio06" data-toggle="modal" class="cbp-caption"
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio05" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio60" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-12.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item real-estate-property accounting fundst medical ecommerce management justice identity">
              <a href="#portfolio08" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/3-portfolio.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item travel-hospitality accounting garments ecommerce management justice graphic identity">
              <a href="#portfolio21" data-toggle="modal" class="cbp-caption"
                data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div
              class="cbp-item automotive-transport accounting agriculture garments ecommerce studio networking identity fundst medical management justice">
              <a href="#portfolio10" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div
              class="cbp-item media-entertainment graphic agriculture garments ecommerce education studio networking graphic identity fundst medical management justice">
              <a href="#portfolio07" data-toggle="modal" class="cbp-caption"
                data-title="Workout Buddy<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/ls-portfolio.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>Software and Hi-tech</small><br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio67" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-19.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div
              class="cbp-item real-estate-property agriculture garments education studio networking identity fundst medical management justice">
              <a href="#portfolio18" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div
              class="cbp-item sports-team-leagues agriculture artphotography communication education studio networking graphic identity">
              <a href="#portfolio13" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio61" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-13.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item automotive-transport artphotography communication education restaurant identity"> <a
                href="#portfolio03" data-toggle="modal" class="cbp-caption "
            ...
            <div
              class="cbp-item education-human-resource identity artphotography communication electronic restaurant graphic identity">
              <a href="#portfolio02" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div class="cbp-item automotive-transport automotive communication electronic restaurant graphic identity">
              <a href="#portfolio11" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio66" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-18.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item media-entertainment graphic automotive construction electronic restaurant identity"> <a
                href="#portfolio14" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div
              class="cbp-item education-human-resource identity automotive construction entertainment technology identity">
              <a href="#portfolio19" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div class="cbp-item web-design "> <a href="#portfolio30" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/Home-(SA)-(8)-Financial-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio31" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/N_Battle-League-gaming-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio63" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-15.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio47" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/takecareofyourbills-t-financial.png')}}">
                </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design"> <a href="#portfolio32" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/N_EGI-Applications-Inc-Advertising-t.png')}}">
                </div>
                <div class="cbp-caption-activeWrap mbgblue">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design"> <a href="#portfolio33" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/N_gresilva-USA-health-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio34" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/N_Perceptive-MG-travel-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio43" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/mnlakestransportation-t-automative.png')}}">
                </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio57" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-10.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblue">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item travel-hospitality"> <a href="#portfolio35" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/N_VW-Breakers-UK-AUTOMATIVE-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio40" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/NK_R-CISC_R6-softwear-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblue">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio65" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-17.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio36" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/NK_Afro-Signatures_R1-media-t.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio38" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/NK_Get-Real-Stone-real-state-t.png')}}">
                </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design"> <a href="#portfolio41" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/bitgen-t-softwear.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio06" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio50" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-03.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio90" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-20.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio10" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item web-design"> <a href="#portfolio42" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/logosanctuary-t-advertising.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio44" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/olfitness-t-sports.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblue">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item web-design"> <a href="#portfolio45" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/revolutionary-t-education.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio03" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio04" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item web-design"> <a href="#portfolio46" data-toggle="modal" class="cbp-caption "
                data-title="Digital Menu<br>by Cosmin Capitanu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/sensationnelbridal-t-media.png')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title"><small>WEB UI/UX</small><br>
            ...
            <div class="cbp-item travel-hospitality identity"> <a href="#portfolio12" data-toggle="modal"
                class="cbp-caption " data-title="Digital Menu<br>by Cosmin Capitanu">
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio02" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio07" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio48" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-01.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio49" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-02.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio01" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio51" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-04.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblack">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio52" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-05.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgblue">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio53" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-06.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgyellow">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech mobile"> <a href="#app_portfolio08" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio54" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-07.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphic<br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio55" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-08.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgpink">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="cbp-item software-hi-tech motiongraphic"> <a href="#portfolio62" data-toggle="modal"
                class="cbp-caption" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                <div class="cbp-caption-defaultWrap"> <img src="{{asset('assets/img/portfolio/motion-graphics-14.gif')}}"> </div>
                <div class="cbp-caption-activeWrap mbgorange">
                  <div class="cbp-l-caption-alignCenter">
                    <div class="cbp-l-caption-body">
                      <div class="cbp-l-caption-title">Motion Graphics<br>
            ...
            <div class="testimonial-details">
              ...
              <div class="testimonial-sec-tab">
                <div class="testimonial-sec-inner clearfix">
                  ...
                  <p>Received my project on time and provided me proper assistance along the way. Loved working with
                    them! </p>
            ...
            <div class="testimonial-details">
              ...
              <div class="testimonial-sec-tab">
                <div class="testimonial-sec-inner clearfix">
                  ...
                  <p>Thanks to Design Proficient, my website is now performing excellently. I’ve worked with them on 5
            ...
            <div class="testimonial-details">
              ...
              <div class="testimonial-sec-tab">
                <div class="testimonial-sec-inner clearfix">
                  ...
                  <p>The team provided me proper identity and branding solutions. I'll be working with them over new
