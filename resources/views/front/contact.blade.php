...
@section('title')
    <title>Discuss with the best logo and web designers in the town | Contact Us | The Logic Hive </title>
@endsection
...
<style type="text/css">
  ...
  <div class="contact">
    <section class="contact-topinfo">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3>Set a meeting with our professionals or call us today to discuss your project with our team of
              industry-proven professionals</h3>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            <p>Say hello! Or maybe just grab a coffee with one of our business analysts so we can get to know you and
              your project better.</p>
            <div class="actions"> <a href="#"> <i class="fa fa-phone-square"></i>{{$phoneNumber}}</a> <br>
              <a href="mailto:share@thelogichive.com"> <i class="fa fa-envelope"></i>share@thelogichive.com</a>
            </div>
          </div>
          <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-4  col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="actions">
              ...
              <a href="mailto:idea@thelogichive.com"> <i class="fa fa-envelope"></i>idea@thelogichive.com</a>
            </div>
            <div class="actions">
              <p>For placement enquiries contact us at:</p>
              <a href="mailto:query@thelogichive.com"> <i class="fa fa-envelope"></i>query@thelogichive.com</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row is_table">
            ...
            <div class="col-md-6  col-lg-6 col-sm-6 col-xs-12 is_cell">
              <div class="single-address">
                ...
                <div class="actions"> <a href="#"> <i class="fa fa-phone-square"></i>{{$phoneNumber}}</a>
                  <a href="mailto:us@thelogichive.com"> <i class="fa fa-envelope"></i>us@thelogichive.com</a> <a
                    href="mailto:us@thelogichive.com" class="btn-fill">Send Query</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6  col-lg-6 col-sm-6 col-xs-12 is_cell">
              <div class="single-address">
                ...
                <div class="actions"> <a href="#"> <i class="fa fa-phone-square"></i>+44-800-0418105</a>
                  <a href="mailto:uk@thelogichive.com"> <i class="fa fa-envelope"></i>uk@thelogichive.com</a> <a
                    href="mailto:uk@thelogichive.com" class="btn-fill">Send Query</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row is_table">
            ...
            <div class="col-md-6  col-lg-6 col-sm-6 col-xs-12 is_cell">
              <div class="single-address">
                ...
                <div class="actions"> <a href="#"> <i class="fa fa-phone-square"></i>{{$phoneNumber}}</a> <a href="#"> <i
                      class="fa fa-envelope"></i>uae@thelogichive.com</a> <a href="mailto:uae@thelogichive.com"
                    class="btn-fill">Send Query</a> </div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCaUuUT2NLz8kEWCddl5s5KpYVMclPpuI&amp;callback=initMap"
