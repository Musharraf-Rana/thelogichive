        ...
        <div class="container">
          <div class="row">
            <div class="col-md-push-2 col-md-8">
              ...
              <div class="text-center logo"><a href="{{route('home')}}"><img src="{{asset('assets/img/logo-inside.png')}}"></a></div>
              ...
              <p class="text-center grey">If you are interested in speaking with The Logic Hive about an upcoming
                project, <br> there are a number of ways we can make that happen.

                Filling out the form would <br> help us get the right person in touch with you, or you could give us a
                call.</p>
              <section class="main-book-call">
                <div class="d_t">
                  <div class="d_c">

                    <form class="book-call-form" method="POST" autocomplete="false"
                      action="https://www.designproficient.com/call/book">

                      <div class="row">
                        <div class="col-md-12 col-xs-12 margin-bottom-30">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 margin-bottom-20">
                          <input type="name" autocomplete="off" class="form-control" placeholder="Name" name="name"
                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" required="required">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 margin-bottom-20">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 margin-bottom-20">
                          <input id="datetimepicker_start_time" type="text" placeholder="Select Date" name="date"
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20">
                          <textarea class="form-control" name="description" placeholder="Project Description"
                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Description'"
            ...
            <div class="col-md-12 clearfix">
              ...
              <p class="clearfix">
                ...
                <span>
                  ...
                  <small class="phone-number"><a href="mailto:idea@designproficient.com"
                      target="_top">idea@designproficient.com </a></small>
                  <small class="phone-number"><a href="mailto:share@designproficient.com"
                      target="_top">share@designproficient.com </a></small>
